          ...
          {products.map((product) => {
            ...
            return (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className={` border border-gray-300 rounded-lg shadow-lg overflow-hidden transition-transform duration-200 hover:shadow-xl relative ${isOutOfStock ? "opacity-70" : ""}`}
              >
